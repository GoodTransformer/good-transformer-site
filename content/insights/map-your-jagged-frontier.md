...
Mollick, who co-authored that study, makes the point that ["unless you use AI a lot, you won't know which is which."](https://www.oneusefulthing.org/p/centaurs-and-cyborgs-on-the-jagged) The edge is real, it is specific to the task, and it is invisible until you test it. Dr Philippa Hardman, who studies how these tools land in real practice, reaches the [same conclusion from her own field](https://drphilippahardman.substack.com/p/defining-and-navigating-the-jagged): the frontier has to be mapped task by task, because it does not match anyone's intuition about what should be easy.
...
- [Dell'Acqua, McFowland, Mollick et al., "Navigating the Jagged Technological Frontier," Harvard Business School Working Paper 24-013](https://mitsloan.mit.edu/sites/default/files/2023-10/SSRN-id4573321.pdf), 22 September 2023. The field experiment behind this post: 758 BCG consultants, big gains inside the frontier and a real drop just outside it. A pre-registered academic study, not vendor research.
- [Ethan Mollick, "Centaurs and Cyborgs on the Jagged Frontier," One Useful Thing](https://www.oneusefulthing.org/p/centaurs-and-cyborgs-on-the-jagged), 16 September 2023. Mollick's own write-up, where the phrase "jagged frontier" comes from and the point that the edge stays invisible until you test it.
- [Dr Philippa Hardman, "Defining and Navigating the Jagged Frontier in Instructional Design"](https://drphilippahardman.substack.com/p/defining-and-navigating-the-jagged), October 2025. A practitioner reaching the same conclusion from her own field: you have to map the frontier task by task.
