---
title: "Map your own jagged frontier before you buy anything"
description: "AI is brilliant at one task and quietly poor at a near-identical one. Vendor demos cannot show you the edge. Here is a cheap, structured way to find where AI reliably helps in your business and where it silently fails."
date: 2026-05-26
type: post
voice: brand
tags: ["working-with-ai", "small-business", "use-cases"]
cover: /insights/map-your-jagged-frontier/cover.jpg
coverAlt: "Dark teal cover with an uneven jagged-edge motif and the Good Transformer wordmark, marking an article on mapping where AI helps and where it fails."
coverQuote: "You learn the edge by walking it, not by watching a demo."
featured: false
draft: false
---

AI is uneven in a way that catches people out. It will draft a tricky client email beautifully, then get a simple sum wrong with total confidence. It will summarise a long document well, then invent a fact that was never in it. The capability is not a smooth slope from easy to hard. It is jagged: excellent on one task and quietly poor on a near-identical one that looks no harder. Researchers gave this a name, the jagged frontier, and for a small firm it has a blunt practical consequence. You cannot tell from the outside where the edge sits. You have to find it in your own work.
...
The clearest evidence comes from a large field experiment. Researchers from Harvard and others ran a pre-registered study with [758 Boston Consulting Group consultants](https://mitsloan.mit.edu/sites/default/files/2023-10/SSRN-id4573321.pdf). On tasks that sat inside the technology's strengths, consultants using GPT-4 completed 12.2% more tasks, 25.1% faster, and produced work rated around 40% higher in quality. Then the researchers handed them a task chosen to sit just outside that range, the kind where the model is confidently wrong. On that task, performance dropped by roughly 19 percentage points against colleagues working without the tool. Same people, same model, same afternoon. The only thing that changed was which side of the frontier the work sat on.

Ethan Mollick, who co-authored that study and writes about it for a general audience, makes the point that ["unless you use AI a lot, you won't know which is which."](https://www.oneusefulthing.org/p/centaurs-and-cyborgs-on-the-jagged) The edge is real, it is specific to the task, and it is invisible until you test it. Dr Philippa Hardman, who studies how these tools land in real practice, reaches the same conclusion from her own field: the frontier ["must be mapped"](https://drphilippahardman.substack.com/p/defining-and-navigating-the-jagged) task by task, because it does not match anyone's intuition about what should be easy.
...
Choosing where to point AI first, on evidence rather than hype, is the heart of the [AI Reality Check Sprint](/services/ai-advisory-for-teams): mapping the frontier across a team's real work and leaving them with a defensible order to work through. If that is the decision in front of you, [book a business call](/book/business/) and we will run it together.

## Sources and further reading

- [Dell'Acqua, McFowland, Mollick et al., "Navigating the Jagged Technological Frontier," Harvard Business School Working Paper 24-013](https://mitsloan.mit.edu/sites/default/files/2023-10/SSRN-id4573321.pdf), 22 September 2023. Independent pre-registered field experiment with 758 BCG consultants. Source for the within-frontier gains and the drop on a task outside it.
- [Ethan Mollick, "Centaurs and Cyborgs on the Jagged Frontier," One Useful Thing](https://www.oneusefulthing.org/p/centaurs-and-cyborgs-on-the-jagged), 16 September 2023. Source for the "jagged frontier" framing and the point that the edge is invisible until tested.
- [Dr Philippa Hardman, "Defining and Navigating the Jagged Frontier in Instructional Design"](https://drphilippahardman.substack.com/p/defining-and-navigating-the-jagged), October 2025. An independent practitioner-researcher. Source for the point that the frontier must be mapped task by task.
