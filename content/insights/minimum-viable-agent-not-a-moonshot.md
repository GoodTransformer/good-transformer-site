...
cover: /insights/minimum-viable-agent-not-a-moonshot/cover.jpg
coverAlt: "Dark teal cover with a single small building-block motif and the Good Transformer wordmark, marking an article on starting with a minimum viable AI agent."
coverQuote: "One job, done end to end, beats a grand plan you never finish."
featured: false
draft: false
---
...
Working out which job is the right first one, and keeping the scope honest so it actually ships, is the practical heart of the [AI Advisory for Teams](/services/ai-advisory-for-teams) work. If you want a first agent that earns its place rather than a plan that never finishes, [book a business call](/book/business/).
