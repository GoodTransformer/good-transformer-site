---
title: "Centaur or cyborg: how a small team should split work with AI"
description: "The useful question is not which AI tool to buy. It is how you and the machine divide each job. A simple test for sorting your week into clean handoffs and close collaboration."
date: 2026-05-27
type: post
voice: brand
tags: ["working-with-ai", "small-business", "ai-adoption"]
cover: /insights/centaur-or-cyborg-split-work-with-ai/cover.jpg
coverAlt: "Dark teal cover with a divided-path motif and the Good Transformer wordmark, marking an article on splitting work between a person and AI."
coverQuote: "Decide who holds the pen before the work starts."
featured: false
draft: false
---
...
Mollick's own warning is the reason this matters. ["On some tasks AI is immensely powerful, and on others it fails completely or subtly,"](https://www.oneusefulthing.org/p/centaurs-and-cyborgs-on-the-jagged) he writes, "and, unless you use AI a lot, you won't know which is which." A demo cannot tell you where your work sits on that uneven edge. Only your own tasks can. So the operating model has to be decided task by task, not bought in a single licence.
...
Some work has no clean seam. You do not know what good looks like until you see a few attempts, and each attempt changes what you ask for next. This is cyborg work, where you and the model ["intertwine"](https://www.oneusefulthing.org/p/centaurs-and-cyborgs-on-the-jagged) your effort.

Think of pricing a piece of unusual work, or shaping a proposal for a client who does not fit your normal mould. You throw a rough idea at the model, it offers three framings, one sparks a better thought, you push back, it sharpens. Nobody handed over a finished brief, because there was no finished brief to hand. The value is in the back-and-forth. Simon Willison, a developer who writes plainly about daily AI use, suggests treating the model as ["an over-confident pair programming assistant"](https://simonw.substack.com/p/how-i-use-llms-to-help-me-write-code): fast, useful, sitting beside you, and wrong often enough that you stay in the loop. That is cyborg posture. You are not delegating. You are thinking out loud with a fast, fallible partner.
