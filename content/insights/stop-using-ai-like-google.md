...
type: post
voice: brand
tags: ["working-with-ai", "prompting", "small-business"]
cover: /insights/stop-using-ai-like-google/cover.jpg
coverAlt: "Dark teal cover with a search-box motif giving way to a conversation thread and the Good Transformer wordmark, marking an article on moving past the search-engine habit with AI."
coverQuote: "Treat it as a search box and it answers like one."
featured: false
draft: false
---
...
For twenty years we have all been trained by search engines to do one thing: type a few keywords, scan a list of links, click one, find the answer ourselves. That habit is deep, and it is exactly the wrong instinct for AI. Conor Grennan, who teaches people to work with these tools, has a name for this, the search-engine mindset, and it is the single most common reason capable users get disappointing results. Treat the model like Google and you waste almost everything it can do.
...
Helping people and teams build that working habit, rather than abandoning the tools after a disappointing first go, is much of what the [AI Lessons for Leaders](/services/ai-lessons-for-leaders/) sessions do. If AI has underwhelmed you so far, [book a personal lesson](/book/personal/) and we will change how you work with it.
