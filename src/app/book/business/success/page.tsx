...
export const metadata: Metadata = buildPageMetadata({
  ...seoContent.pages.businessSuccess,
  noIndex: true,
});

export default function BusinessBookingSuccessPage() {
  const content = bookingSuccessPage.business;
